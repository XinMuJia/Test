...
//             u16 i = gpio_read(IO_PORTB_11);
//             log_info("PRE:%d", i);
//             // 连续按键1s以上，按键开机
//             if (delay_10ms_cnt > 100) { //1s
...
//             // 关机检测：开机后继续长按3秒关机
//             if (delay_10ms_cnt > 400 && poweron_detected) { //总共4秒
