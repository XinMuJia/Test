...
#define TCFG_UART0_RX_PORT					IO_PORTA_11 //NO_CONFIG_PORT           //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
#define TCFG_UART0_TX_PORT  				IO_PORTA_10                            //串口发送脚配置
#define TCFG_UART0_BAUDRATE  				1000000                                //串口波特率配置

#define UART_DB_TX_PIN                      IO_PORTA_12 //A01                            //AT_CHART串口
#define UART_DB_RX_PIN                      IO_PORTC_02
#define UART_DB_RTS_PIN                     IO_PORTA_13 //A06
...
//*********************************************************************************//
/*软件IIC设置*/
#define TCFG_SW_I2C0_CLK_PORT               IO_PORTA_06                             //软件IIC  CLK脚选择
#define TCFG_SW_I2C0_DAT_PORT               IO_PORTA_05                             //软件IIC  DAT脚选择
...
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_03        //IO按键端口
...
#define TCFG_IOKEY_NEXT_ONE_PORT			NO_CONFIG_PORT //IO_PORTB_02
#define TCFG_IOKEY_NEXT_ONE_PORT_VALUE		0x3              //next port键值

/* 按键检测：可配置多个按键(自定义) */
#define TCFG_IOKEY_AIR_CONNECT_WAY		    ONE_PORT_TO_LOW         //按键一端接低电平一端接IO
#define TCFG_IOKEY_AIR_ONE_PORT			    IO_PORTB_04             //IO按键端口
#define TCFG_IOKEY_AIR_ONE_PORT_VALUE		0x4                     //air port键值

#define TCFG_IOKEY_AIR_KEY_WAY		        ONE_PORT_TO_LOW     //按键一端接低电平一端接IO
#define TCFG_IOKEY_AIR_KEY_PORT			    IO_PORTB_05         //IO_PORTB_05
#define TCFG_IOKEY_AIR_ONE_PORT_VALUE		0x5                //air port键值
//*********************************************************************************//
//                                 adkey 配置                                      //
//*********************************************************************************//
